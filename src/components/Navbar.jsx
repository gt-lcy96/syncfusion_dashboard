...
const NavButton = ({ title, customFunc, icon, color, dotColor}) => (
    <TooltipComponent content={title} position="BottomCenter">
        <button type="button" onClick={customFunc} stype={{ color }}
...
const Navbar = () => {
  ...
  <div className="flex justify-between p-2 md:mx-6 relative">
    ...
    <div className="flex">
        ...
        color={currentColor} dotColor={lightblue} icon={<BsChatLeft />}/>
        <NavButton title="Notification" customFunc={() => handleClick('notification')} 
        color={currentColor} dotColor={lightblue} icon={<RiNotification3Line />}/>
        <TooltipComponent content="Profile" position="BottomCenter">
            ...
            >
                ...
                <p className="text-gray-400 text-14">
                    <span>Hi,</span>
                    <span className="font-bold ml-1">Loh</span>
                </p>
